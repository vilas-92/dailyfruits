...
<head>
    <meta charset="UTF-8">
    <title>Healthy winter season fruits</title>
...
<body style="background: #eff0ed;">
    ...
    <div class="page-breadcrumb,img-fluid" style="background-image:url('assets/img/blog/feed/blogmenu-image.jpg');">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <ul class="page-breadcrumb__menu">
                        <li class="page-breadcrumb__nav"><a href="index.php">Home</a></li>
                        <li class="page-breadcrumb__nav active">Healthy winter season fruits </li>
                    </ul>
                </div>
            </div>
        </div>
                        ...
                        <div class="sidebar__widget">
                            ...
                            <ul class="sidebar__post-blog list-space--small">
                                <li class="d-flex align-items-center ">
                                    <a class="sidebar__post-img img-responsive" href="Healthy-Winter-Season-Fruits.php">
                                        <img src="assets/img/blog/feed/blogwinter.jpg" alt="">
                                    </a>
                                    <div class="sidebar__post-content">
                                        <span class="d-block color-gray">Sep 29, 2021</span>
                                        <a class="link--gray" href="Healthy-Winter-Season-Fruits.php" target="_blank">Winter season fruits</a>
                                    </div>
                                </li>
                                <br>
                                <li class="d-flex align-items-center">
                                    <a class="sidebar__post-img img-responsive" href="Benefits-of-fruits.php">
                                        <img src="assets/img/blog/feed/blog-dailyfruits.jpg" alt="">
                                    </a>
                                    <div class="sidebar__post-content">
                                        <span class="d-block color-gray">Jul 16, 2021</span>
                                        <a class="link--gray" href="Benefits-of-fruits.php" target="_blank">What are the benefits of fruit</a>
                                    </div>
                                </li>
                                <br>
                                 <li class="d-flex align-items-center">
                                    <a class="sidebar__post-img img-responsive" href="fruits-diet.php">
                                        <img src="assets/img/blog/feed/fruits-diet.jpg" alt="">
                                    </a>
                                    <div class="sidebar__post-content">
                                        <span class="d-block color-gray">Aug 16, 2021</span>
                                        <a class="link--gray" href="fruits-diet.php" target="_blank">Fruits And Vegetables Are Important For The Diet</a>
                                    </div>
                                </li>
                            </ul>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="blog__type-single">
                                    <div class="img-responsive"><img src="assets/img/blog/feed/blogwinter.jpg" alt=""></div>
                                    <div class="blog__content">
                                        <h3 class="blog__title">Winter season fruits</h3>
                                        <div class="blog__archive m-t-20">
                                            <a href="#" class="link--gray link--icon-left m-r-30"><i class="far fa-calendar"></i> Oct 29, 2020</a>
                                            <a href="#" class="link--gray link--icon-left"><i class="far fa-user"></i> Saurabh</a>
                                        </div>
                                        <div class="para m-tb-20">
                                            <p class="para__text">
                                               These winter season fruits are rich in Vitamin C which is an anti-oxidant important in cold weather to maintain body heat and strengthening your immune system. Eating seasonal fruits is not just healthy but they taste better because they are fresh.<br>
                                               <h1>Winter Fruits That Should Be A Part Of Your Daily Diet In Winter</h1>
                                               <h1 style="color: red;">.1 Apple</h1>
                                               <p class="block-quote">You are likely to find apples in most households during winter. Apples have anti-oxidants which improve neurological health and reduce the risk of Alzheimer’s disease. This winter fruit also reduces the risk of diabetes and thrombotic stroke. </p>

                                               <h1 style="color: red;">.2 Grapes</h1>
                                               <p class="block-quote">Grapes are a fruit available throughout the year but they are beneficial as a winter season fruit as they are rich in anti-oxidants. They are also a good source for potassium which can help prevent skin problems. Grapes boost your brain power and are great for your eyes and knees.</p>

                                               <h1 style="color: red;">.3 Kiwi</h1>
                                               <p class="block-quote">Kiwis are a rich source of Vitamin C and keeps you energised throughout the day. It is a good source of dietary fibre and will help you digest all the festive food you will be eating during the winter season. Kiwi has alkaline properties which help keep your body in shape and improve skin health. </p>
                                               <h1 style="color: red;">.4 Oranges</h1>
                                               <p class="block-quote">Oranges are another fruit available throughout the year, that you should eat in the winter. The fruit is not just a rich source of Vitamin C which is important during winter but also reduces the risk of cancer. They are a nutritious snack and you can also blend it into a healthy juice too. </p>

                                               <h1 style="color: red;">.5 Strawberries</h1>
                                              <p class="block-quote"> Strawberries are a winter fruit you probably love of indulge in this season and they have own health benefits too. Strawberries is good for the skin because they are rich in anti-oxidants and it can give your immunity a boost to avoid the usual winter ailments. 
Some more fruits that just missed out on our winter fruits list but would do well in your diet include guavas, pears, pomegranates, papayas and chikoos. You can enjoy these fruits plain, or a fruit salad. Be careful to not blend the fruits too much if you are making a smoothie because they could lose their dietary fibre which can help your digestion.</p>
                                            </p>
